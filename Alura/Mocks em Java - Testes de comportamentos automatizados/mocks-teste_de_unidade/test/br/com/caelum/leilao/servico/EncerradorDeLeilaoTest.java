...
//		LeilaoDao daoFalso = mock(LeilaoDao.class);
    ...
    public void naoDeveEncerrarLeiloesQueComecaramMenosDeUmaSemanaAtras() {
        ...
        //never: garante que o método em questão não foi invocado nenhuma vez
	...
	public void deveAtualizarLeiloesEncerrados() {
		...
		//Verify: faz com que o mockito verifique se o método foi invocado, caso contrário ele falha o teste
		//times: informa a quantidade de vezes que o método em questão deve ser invocado, neste caso, uma única vez
